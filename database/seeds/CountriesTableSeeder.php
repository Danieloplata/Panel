...
class CountriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
    	$countries = [
			...
			["countryCode" => "HM", "countryName" => "Heard Island & Mcdonald Islands"],
			...
			["countryCode" => "GS", "countryName" => "South Georgia And Sandwich Isl."],
			...
			["countryCode" => "UM", "countryName" => "United States Outlying Islands"],
